<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      ...
      <vs-dropdown-item @click="updateLocale('tr')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/tr.png" alt="tr" /> &nbsp;Türkçe</vs-dropdown-item>
      <vs-dropdown-item @click="updateLocale('az')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/az.png" alt="tr" /> &nbsp;Azərbaycanca</vs-dropdown-item>
    </vs-dropdown-menu>
  </vs-dropdown>
</template>
